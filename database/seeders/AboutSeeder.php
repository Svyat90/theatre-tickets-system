...
class AboutSeeder extends Seeder
{
    ...
    public function run()
    {
        $about = About::query()->create($this->data);

        $about->addMediaFromUrl(asset("front/img/about-block-1.jpg"))->toMediaCollection('image_1');
        $about->addMediaFromUrl(asset("front/img/about-block-2.jpg"))->toMediaCollection('image_2');
        $about->addMediaFromUrl(asset("front/img/about-block-2-1.jpg"))->toMediaCollection('image_3');
        $about->addMediaFromUrl(asset("front/img/about-block-3.jpg"))->toMediaCollection('image_4');

        $about->addMediaFromUrl(asset("front/img/about-g-1.jpg"))->toMediaCollection('image_gallery');
        $about->addMediaFromUrl(asset("front/img/about-g-2.jpg"))->toMediaCollection('image_gallery');
        $about->addMediaFromUrl(asset("front/img/about-g-3.jpg"))->toMediaCollection('image_gallery');
        $about->addMediaFromUrl(asset("front/img/about-g-4.jpg"))->toMediaCollection('image_gallery');
        $about->addMediaFromUrl(asset("front/img/about-g-5.jpg"))->toMediaCollection('image_gallery');
        $about->addMediaFromUrl(asset("front/img/about-g-6.jpg"))->toMediaCollection('image_gallery');
        $about->addMediaFromUrl(asset("front/img/about-g-7.jpg"))->toMediaCollection('image_gallery');
    }
