            ...
            <div class="about-blocks">
                ...
                <div class="about-block">
                    ...
                    <div class="block-img-wr">
                        <img src="{{ MediaHelper::getImageUrl($about, 'image_1') }}" alt=""  style="max-width: {{ $maxWidth = 445 }}px;">
                ...
                <div class="about-block">
                    ...
                    <div class="block-img-wr">
                        <img src="{{ MediaHelper::getImageUrl($about, 'image_4') }}" alt="" style="max-width: {{ $maxWidth }}px;">
                    </div>
                </div>
            </div>
