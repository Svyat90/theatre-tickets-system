...
@section('content')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route("admin.categories.create") }}">
                {{ __('global.add') }} {{ __('cruds.categories.title_singular') }}
            </a>
        </div>
    </div>
    ...
    <div class="card">
        <div class="card-header">
            {{ __('cruds.categories.title_singular') }} {{ __('global.list') }}
        </div>
        ...
        <div class="card-body">
            <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-categories">
                ...
                <tr>
                    ...
                    <th>
                        {{ __('cruds.categories.fields.name') }} ({{ app()->getLocale() }})
                    </th>
                    <th>
                        {{ __('cruds.categories.fields.slug') }}
                    </th>
                    <th>
                        {{ __('cruds.categories.fields.active') }}
                    </th>
                    <th>
