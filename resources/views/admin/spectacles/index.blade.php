...
@section('content')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route("admin.spectacles.create") }}">
                {{ __('global.add') }} {{ __('cruds.spectacles.title_singular') }}
            </a>
        </div>
    </div>
    ...
    <div class="card">
        <div class="card-header">
            {{ __('cruds.spectacles.title_singular') }} {{ __('global.list') }}
        </div>
        ...
        <div class="card-body">
            <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-categories">
                ...
                <tr>
                    ...
                    <th>
                        {{ __('cruds.spectacles.fields.author') }} ({{ app()->getLocale() }})
                    </th>
                    <th>
                        {{ __('cruds.spectacles.fields.producer') }} ({{ app()->getLocale() }})
                    </th>
                    <th>
                        {{ __('cruds.spectacles.fields.min_age') }}
                    </th>
                    <th>
                        {{ __('cruds.spectacles.fields.duration') }}
                    </th>
                    <th>
                        {{ __('cruds.spectacles.fields.slug') }}
                    </th>
                    <th>
    ...
    <script>
        $(function () {
            ...
            let dtOverrideGlobals = {
                ...
                retrieve: true,
                aaSorting: [],
                ajax: "{{ route('admin.spectacles.index') }}",
                columns: [
