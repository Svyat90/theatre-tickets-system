...
@section('content')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route("admin.articles.create") }}">
                {{ __('global.add') }} {{ __('cruds.articles.title_singular') }}
            </a>
        </div>
    </div>
    ...
    <div class="card">
        <div class="card-header">
            {{ __('cruds.articles.title_singular') }} {{ __('global.list') }}
        </div>

        <div class="card-body">
            <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-articles">
                <thead>
                <tr>
                    <th width="10">
                    ...
                    <th>
                        {{ __('cruds.articles.fields.name') }} ({{ app()->getLocale() }})
                    </th>
                    <th>
    ...
    <script>
        $(function () {
            ...
            let deleteButton = {
                ...
                url: "{{ route('admin.articles.multi_destroy') }}",
            ...
            $('.datatable-articles').DataTable(dtOverrideGlobals);
